/*
 * Title:   Joebante - Travel, Tour Booking  - Main Javascript file
...
function changeJoebanteElementUI() {
...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
		...
		var navbarBrand = tjq('.navbar-brand').clone(true, true);
        tjq(navbarBrand).insertBefore('.chaser .menu');
